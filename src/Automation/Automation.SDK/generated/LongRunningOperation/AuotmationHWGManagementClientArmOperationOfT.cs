...
#pragma warning disable SA1649 // File name should match first type name
    internal class AuotmationHWGManagementClientArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of AuotmationHWGManagementClientArmOperation for mocking. </summary>
        protected AuotmationHWGManagementClientArmOperation()
        {
        }

        internal AuotmationHWGManagementClientArmOperation(Response<T> response)
        {
            _operation = OperationInternal<T>.Succeeded(response.GetRawResponse(), response.Value);
        }

        internal AuotmationHWGManagementClientArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(clientDiagnostics, nextLinkOperation, response, "AuotmationHWGManagementClientArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
