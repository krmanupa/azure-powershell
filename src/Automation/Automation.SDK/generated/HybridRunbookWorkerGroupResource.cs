...
namespace AuotmationHWGManagementClient
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetHybridRunbookWorkerGroup method.
    /// </summary>
    public partial class HybridRunbookWorkerGroupResource : ArmResource
    {
        ...
        {
            _hybridRunbookWorkerGroupClientDiagnostics = new ClientDiagnostics("AuotmationHWGManagementClient", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AuotmationHWGManagementClientArmOperation(response);
